...
class WeeklyRruleTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testTwentySeven()
    {
        $results[] = new DateTime('1997-09-02 09:00:00');
        $results[] = new DateTime('1997-09-16 09:00:00');
        $results[] = new DateTime('1997-09-30 09:00:00');
     ...
     */
    public function testTwentyEight()
    {
        $results[] = new DateTime('1997-09-02 09:00:00');
     ...
     */
    public function testTwentyNine()
    {
